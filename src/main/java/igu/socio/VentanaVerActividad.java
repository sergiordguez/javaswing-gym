...
public class VentanaVerActividad extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public VentanaVerActividad(ActividadDto act) {
		setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
		setModal(true);
		this.actividad = act;
		setBounds(100, 100, 450, 300);
		setTitle("Gimnasio: Socio: Actividad");
	...
	private JLabel getLbActividad() {
		if (lbActividad == null) {
			lbActividad = new JLabel(actividad.getTipo());
